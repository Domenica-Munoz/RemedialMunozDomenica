...
a persistence unit "RecuperacionPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Recuperacion\pom.xml":
...
artifact ("Recuperacion.war") is already built. You can build
